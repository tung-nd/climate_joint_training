...
from .era5_iterdataset import (Forecast, IndividualForecastDataIter,
...
class ERA5IterDatasetModule(LightningDataModule):
    ...
    def get_climatology(self, split='val', variables=None):
        path = os.path.join(self.hparams.root_dir, split, 'climatology.npz')
