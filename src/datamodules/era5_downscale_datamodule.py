...
from .era5_dataset import ERA5Downscaling
...
class ERA5DownscaleDataModule(LightningDataModule):
    def __init__(
        self,
        root_dir,
        highres_root_dir,
        ...
        self.train_dataset = ERA5Downscaling(root_dir, highres_root_dir, inp_vars, inp_pressure_levels, out_vars, out_pressure_levels, train_years, subsample, 'train')

        val_years = range(val_start_year, test_start_year)
        self.val_dataset = ERA5Downscaling(root_dir, highres_root_dir, inp_vars, inp_pressure_levels, out_vars, out_pressure_levels, val_years, subsample, 'val')
        ...
        self.test_dataset = ERA5Downscaling(root_dir, highres_root_dir, inp_vars, inp_pressure_levels, out_vars, out_pressure_levels, test_years, subsample, 'test')
